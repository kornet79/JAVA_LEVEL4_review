...
// 리모컨과 페어링되고, TV의 전원이 켜져 있는 상태에만 채널 변경 가능
    ...
    public void adjustVolume(int level) {
        if(powerOn) {
            ...
            System.out.println("Apple TV is not Content");
        }
    }
    ...
    // TV의 전원이 켜져 있을 때만 Wave 시청할 수 있음.
        if (powerOn) {
            System.out.println("Apple TV: Now streaming Wave.");
        } else {
            System.out.println("Apple TV is OFF. Cannot stream Wave.");
        }
    }
}
